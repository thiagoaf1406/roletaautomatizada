            ...
            <div class="header">
                <div class="logo logo-dark" style="overflow:hidden;">
                    <a href="<?=ADMIN?>">
                        <img src="assets/images/logo/<?=$sistema->logo?>" style="width:60%;" alt="<?=TITULO?>">
                        <img class="logo-fold" src="assets/images/logo/<?=$sistema->logo?>" alt="<?=TITULO?>">
                    </a>
                </div>
                        ...
                        <li class="dropdown dropdown-animated scale-left">
                            <div class="pointer" data-toggle="dropdown">
                                <div class="avatar avatar-image  m-h-10 m-r-15">
                                    <img src="<?=URL?>imagens/usuarios/<?=$usuario->imagem?>"  alt="">
                                </div>
                            </div>
