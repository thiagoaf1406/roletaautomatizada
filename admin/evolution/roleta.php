...
$u = RoletaEvolution::find($id);
$edicao = true;
$titulo = 'Editar Roleta';

$ativa = 'Evolution Roletas';
            ...
            <div class="page-container">
                ...
                <div class="main-content">
                    <div class="page-header">
                        <h2 class="header-title">Evolution Roleta</h2>
    ...
    <script>
        $("#form-roleta").submit(function(e){
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "evolution/actions/atualizaRoleta",
                data: formDados,
                processData: true,
                success: function(data){
                    ...
                    if(data.sucesso == true){
                       ...
                       setTimeout(function(){ location.href="evolution/roletas"; }, 1000);
                    } else {
