                        ...
                        <div class="card-body">
                            ...
                            <div class="m-t-25">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Lucro / ODD:</label>
										    <input class="form-control m-b-10" type="text" id="lucro" name="lucro" placeholder="Lucro" value="<?=$u->lucro?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
										    ...
										    <input class="form-control m-b-10" type="text" id="confirma" name="confirma" placeholder="Quantidade de repetições" value="<?=$u->confirma?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if(data.sucesso == true){
                       ...
                       setTimeout(function(){ location.href="roleta/"; }, 1000);
                    } else {
