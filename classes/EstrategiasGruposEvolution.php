...
class EstrategiasGruposEvolution extends ActiveRecord {
    ...
    function getTable() {
		return 'estrategiasGruposEvolution';
	}
	...
	public static function find($id = 0, $conditions = null, $order = 'id DESC') {
		...
		$result = self::load('estrategiasGruposEvolution','EstrategiasGruposEvolution',$conditions,$order);
