...
class Usuario extends ActiveRecord {
	...
	public static function find($id = 0, $conditions = null, $order = 'nome ASC') {
		...
		$result = self::load('usuarios','Usuario',$conditions,$order);
	...
	public static function gerarBotoes($id){
        ...
        $menu .= '<a href="usuarios/usuario?id='.$id.'"><button class="dropdown-item" type="button"><i class="fa fa-edit"></i> Editar</button></a>';
