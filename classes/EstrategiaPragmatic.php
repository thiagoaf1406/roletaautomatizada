...
class EstrategiaPragmatic extends ActiveRecord {
	...
	public static function find($id = 0, $conditions = null, $order = 'id ASC') {
		...
		$result = self::load('estrategiasPragmatic','EstrategiaPragmatic',$conditions,$order);
    ...
    public static function gerarBotoes($id){
        ...
        $menu .= '<a href="pragmatic/estrategias/estrategia?id='.$id.'"><button class="dropdown-item" type="button"><i class="fa fa-edit"></i> Editar</button></a>';
