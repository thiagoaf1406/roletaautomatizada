...
class EntradaGrupoPragmatic extends ActiveRecord {
	...
	public static function find($id = 0, $conditions = null, $order = 'id DESC') {
		...
		$result = self::load('entradasGrupoPragmatic','EntradaGrupoPragmatic',$conditions,$order);
