...
class Estrategia extends ActiveRecord {
	...
	public static function find($id = 0, $conditions = null, $order = 'id ASC') {
		...
		$result = self::load('estrategias','Estrategia',$conditions,$order);
    ...
    public static function gerarBotoes($id){
        ...
        $menu .= '<a href="roleta/estrategia?id='.$id.'"><button class="dropdown-item" type="button"><i class="fa fa-edit"></i> Editar</button></a>';
