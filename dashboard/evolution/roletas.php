            ...
            <div class="page-container">
                ...
                <div class="main-content">
                    <div class="page-header">
                        <h2 class="header-title">Evolution - Roletas</h2>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4>Gerenciamento de Roletas</h4>
                            <!--begin::Table-->
                            <div class="row">
                                <div class="col-md-12">
									...
									<table id="tabela" class="table">
										<thead>
											<tr class="text-left">
												...
												<th>Nome</th>
												<th>Status</th>
												<th style="word-wrap:break-word;">Link</th>
											</tr>
										</thead>
										<tbody>
										</tbody>
    ...
    <script>
        function atualizaStatus(status, id){
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "evolution/actions/atualizaStatusRoleta",
        ...
        $(document).ready(function() {
            $('#tabela').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": "evolution/actions/roletas.php",
                "language": {
