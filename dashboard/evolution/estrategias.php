            ...
            <div class="page-container">
                ...
                <div class="main-content">
                    <div class="page-header">
                        <h2 class="header-title">Evolution Estratégias</h2>
    ...
    <script>
        $(document).ready(function() {
            $('#tabela').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": "evolution/actions/estrategias.php",
                "language": {
        ...
        function atualizaStatus(status, id){
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "evolution/actions/atualizaEstrategia.php",
