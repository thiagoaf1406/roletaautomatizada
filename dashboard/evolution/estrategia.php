...
$id = $_REQUEST['id'];
$estrategias = EstrategiaEvolution::find(0, array("id = '".$id."' AND usuario = '".$_SESSION['usuario_id']."'"));
if(count($estrategias) >=1){
$u = EstrategiaEvolution::find($id);
$edicao = true;
$titulo = 'Editar Estratégia';

$ativa = 'Evolution Estratégia';
            ...
            <div class="page-container">
                ...
                <div class="main-content">
                    <div class="page-header">
                        <h2 class="header-title">Evolution Estratégia</h2>
                        ...
                        <div class="card-body">
                            ...
                            <div class="m-t-25">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Abortar com 0?</label>
										    <select class="form-control m-b-10" id="abortar" name="abortar" required>
										        <option value="">Selecione</option>
										        <option <? if($u->abortar == 'Sim'){ echo 'selected'; } ?> value="Sim">Sim</option>
										        <option <? if($u->abortar == 'Não'){ echo 'selected'; } ?> value="Não">Não</option>
										    </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Cobrir 0?</label>
										    <select class="form-control m-b-10" id="zero" name="zero" required>
										        <option value="">Selecione</option>
										        <option <? if($u->zero == 'Sim'){ echo 'selected'; } ?> value="Sim">Sim</option>
										        <option <? if($u->zero == 'Não'){ echo 'selected'; } ?> value="Não">Não</option>
										    </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Gales</label>
										    <input class="form-control m-b-10" type="number" id="gales" name="gales" placeholder="Quantidade de gales" value="<?=$u->gales?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
    ...
    <script>
        $("#form-estrategia").submit(function(e){
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "evolution/actions/atualizaEstrategia",
                data: formDados,
                processData: true,
                success: function(data){
                    ...
                    if(data.sucesso == true){
                       ...
                       setTimeout(function(){ location.href="evolution/estrategias"; }, 1000);
                    } else {
