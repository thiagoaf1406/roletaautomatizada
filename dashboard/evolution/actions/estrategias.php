...
$table = 'estrategiasEvolution';
 
$primaryKey = 'id';

function status($id){
    $estrategia = EstrategiaEvolution::find($id);
...
$columns = array(
    array('db' => 'id', 'dt' => 0, 'formatter' => function( $d, $row ){ return '<a href="evolution/estrategia?id='.$d.'"><i class="fa fa-edit"></i></a>';  }),
    array('db' => 'nome', 'dt' => 1),
