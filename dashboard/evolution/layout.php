...
$ativa = 'Evolution Layout';
$sistema = Sistema::find(1);
$mensagens = MensagemEvolution::find(0, array("usuario = '".$_SESSION['usuario_id']."'"));
            ...
            <div class="page-container">
                ...
                <div class="main-content">
                    <div class="page-header">
                        <h2 class="header-title">Evolution - Layout de Mensagens</h2>
