...
$ativa= 'Playtech Relatório Roletas';
                        ...
                        <div class="d-md-flex align-items-md-center justify-content-between">
                            <div class="media m-v-10 align-items-center">
                                <div class="media-body m-l-15">
                                    <h4 class="m-b-0">Playtech Relatório Roletas</h4>
                            ...
                            <div class="col-md-6">
                                <div class="form-control">
                                    <select class="form-control" onchange="filtraRoleta(this)">
                                        ...
                                        <?php foreach(Roleta::find(0, array("usuario = '".$_SESSION['usuario_id']."'")) as $r){ ?>
    ...
    <script>
        function filtraRoleta(elm){
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "playtech/actions/filtraRoleta",
                data: { id:id },
                processData: true,
