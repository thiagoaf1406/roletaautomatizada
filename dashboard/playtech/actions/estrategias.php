...
$columns = array(
    array('db' => 'id', 'dt' => 0, 'formatter' => function( $d, $row ){ return '<a href="playtech/estrategia?id='.$d.'"><i class="fa fa-edit"></i></a>';  }),
    array('db' => 'nome', 'dt' => 1),
...
$resposta = SSP::simple($_GET, $sql_details, $table, $primaryKey, $columns, "usuario = '".$_SESSION['usuario_id']."'");
