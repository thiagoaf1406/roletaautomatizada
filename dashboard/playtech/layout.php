...
$ativa = 'Playteh Layout';
$sistema = Sistema::find(1);
$mensagens = Mensagem::find(0, array("usuario = '".$_SESSION['usuario_id']."'"));
            ...
            <div class="page-container">
                ...
                <div class="main-content">
                    <div class="page-header">
                        <h2 class="header-title">Playtech - Layout de Mensagens</h2>
