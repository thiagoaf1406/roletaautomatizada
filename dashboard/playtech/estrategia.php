...
$id = $_REQUEST['id'];
$estrategias = Estrategia::find(0, array("id = '".$id."' AND usuario = '".$_SESSION['usuario_id']."'"));
if(count($estrategias) >=1){
$u = Estrategia::find($id);
$edicao = true;
$titulo = 'Editar Estratégia';

$ativa = 'Playtech Estratégia';
            ...
            <div class="page-container">
                ...
                <div class="main-content">
                    <div class="page-header">
                        <h2 class="header-title">Playtech Estratégia</h2>
    ...
    <script>
        $("#form-estrategia").submit(function(e){
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "playtech/actions/atualizaEstrategia",
                data: formDados,
                processData: true,
                success: function(data){
                    ...
                    if(data.sucesso == true){
                       ...
                       setTimeout(function(){ location.href="playtech/estrategias"; }, 1000);
                    } else {
