                            ...
                            <div class="m-t-25">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>ChatID</label>
										    <input class="form-control m-b-10" type="text" id="chatID" name="chatID" placeholder="ChatID Telegram" value="<?=$u->chatID?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Telefone</label>
										    <input class="form-control m-b-10" type="text" id="telefone" name="telefone" placeholder="Telefone" value="<?=$u->telefone?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Senha</label>
                                            <input class="form-control m-b-10" type="password" id="senha" name="senha" placeholder="Senha *" value="<?=base64_decode($u->senha)?>" required>
                                        </div>
                                    </div>
