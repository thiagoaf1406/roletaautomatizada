...
$roletas = Roleta::find(0, array("id = '".$id."' AND usuario = '".$_SESSION['usuario_id']."'"));
if(count($roletas) >=1){
$u = $roletas[0];
$edicao = true;
                                    ...
                                    <div class="row">
                               			...
                               			<div class="col-md-6">
                                            <div class="form-group">
                                                <label>Nome</label>
                                                <input class="form-control m-b-10" type="text" id="nome" name="nome" placeholder="Nome da Roleta *" value="<?=$u->nome?>" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
