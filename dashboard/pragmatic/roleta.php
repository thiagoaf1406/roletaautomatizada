...
$u = RoletaPragmatic::find($id);
$edicao = true;
$titulo = 'Editar Roleta';

$ativa = 'Pragmatic Roletas';
            ...
            <div class="page-container">
                ...
                <div class="main-content">
                    <div class="page-header">
                        <h2 class="header-title">Pragmatic Roleta</h2>
                        ...
                        <div class="card-body">
                            ...
                            <div class="m-t-25">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Link Desktop</label>
                                            <input class="form-control m-b-10" type="text" id="link" name="link" placeholder="Link Desktop da Roleta *" value="<?=$u->link?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Link Mobile</label>
                                            <input class="form-control m-b-10" type="text" id="mobile" name="mobile" placeholder="Link Mobile da Roleta *" value="<?=$u->mobile?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
    ...
    <script>
        $("#form-roleta").submit(function(e){
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "pragmatic/actions/atualizaRoleta",
                data: formDados,
                processData: true,
                success: function(data){
                    ...
                    if(data.sucesso == true){
                       ...
                       setTimeout(function(){ location.href="pragmatic/roletas"; }, 1000);
                    } else {
