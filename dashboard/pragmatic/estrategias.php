            ...
            <div class="page-container">
                ...
                <div class="main-content">
                    <div class="page-header">
                        <h2 class="header-title">Pragmatic Estratégias</h2>
    ...
    <script>
        $(document).ready(function() {
            $('#tabela').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": "pragmatic/actions/estrategias.php",
                "language": {
        ...
        function atualizaStatus(status, id){
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "pragmatic/actions/atualizaEstrategia.php",
